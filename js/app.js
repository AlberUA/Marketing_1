(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-cases__body")) new core(".slider-cases__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.5,
        ...
        if (document.querySelector(".slider-about__body")) new core(".slider-about__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".slider-news__body")) new core(".slider-news__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
